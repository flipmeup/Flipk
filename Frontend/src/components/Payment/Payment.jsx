...
const Payment = () => {
    ...
    const handlePayment = () => {
        ...
        const merchantCode = '39242343'; // Merchant ID provided
        const currency = 'INR';
        const note = siteName;
        const signature = '5288b258e28846eba9da6dc53838c112'; // API key provided
            ...
            <div className="card pt-3">
                ...
                <div className="card px-3 py-4 mb-8" id="price-detail">
                    ...
                    <div className="price-info">
                        ...
                        <span>₹{parseFloat(product.sellingPrice).toFixed(2)}</span>
                    </div>
                    <button id="pricepay" className="btn w-100 py-2 mt-4" onClick={handlePayment}>
                        Pay Now
                    </button>
                </div>
            </div>
